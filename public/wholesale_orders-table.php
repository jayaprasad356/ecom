            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Latest Wholesale Orders</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="tab-content">
                                    ...
                                    <table class="table no-margin" data-toggle="table" id="order_list" data-url="api-firebase/get-bootstrap-table-data.php?table=wholesale_orders" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-columns="true" data-show-refresh="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-query-params="queryParams_1" data-show-footer="true" data-footer-style="footerStyle" data-show-export="true" data-export-types='["txt","excel"]' data-export-options='{"fileName": "orders-list-<?= date('d-m-Y') ?>","ignoreColumn": ["operate"] }'>
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="order_note" data-sortable='false' data-visible="false">W.Order Note</th>
                                                ...
                                                <th data-field="date_added" data-sortable='true' data-visible="false">W.O.Date</th>
                            ...
                            <div id="order_items" class="tab-pane fade">
                                <div class="table-responsive">
                                    <table class="table no-margin" data-toggle="table" id="orderitem_list" data-url="api-firebase/get-bootstrap-table-data.php?table=wholesale_order_items" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-columns="true" data-show-refresh="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-sort-name="oi.id" data-sort-order="desc" data-query-params="queryParams" data-show-footer="true" data-footer-style="footerStyle">
                                        <thead>
                                            <tr>
                                                <th data-field="order_id" data-sortable='true'>WO.ID</th>
                                                <th data-field="id" data-sortable='true'>WO.Item ID</th>
                                                <th data-field="user_id" data-sortable='true' data-visible="false">User ID</th>
                                                ...
                                                <th data-field="order_note" data-sortable='false' data-visible="false">WOrder Note</th>
                                                <th data-field="total" data-sortable='true' data-visible="true" data-footer-formatter="priceFormatter">Total(<?= $settings['currency'] ?>)</th>
                                                <!-- <th data-field="delivery_charge" data-sortable='true' data-footer-formatter="delivery_chargeFormatter">D.Chrg</th> -->
                                                <th data-field="tax" data-sortable='false'>Tax <?= $settings['currency'] ?>(%)</th>
                                                <!-- <th data-field="discount" data-sortable='true' data-visible="true">Disc.<?= $settings['currency'] ?>(%)</th> -->
                                                ...
                                                <th data-field="status" data-sortable='true' data-visible='false'>Status</th>
                                                <th data-field="active_status" data-sortable='true' data-visible='true'>A.Status</th>
                                                <th data-field="date_added" data-sortable='true' data-visible="false">WO.Date</th>
                                                <th data-field="operate">Action</th>
                                            </tr>
                                        </thead>
                                    </table>
...
<script>
    ...
    // $('#orders_table').on('click', function(e) {
    //     e.preventDefault();
    //     $('#filter_order1').hide();

    // });
    // $('#orders_item_table').on('click', function(e) {
    //     e.preventDefault();
    //     $('#filter_order1').show();
