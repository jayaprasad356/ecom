...
define('DOMAIN_URL', 'http://onlukr.greymatterworks.in/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u743445510_onlukr";  // Change as required
    private $db_pass = "Onlukr@2022";  // Change as required
    private $db_name = "u743445510_onlukr";    // Change as required
